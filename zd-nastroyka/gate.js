/* A-Players · Платформа онбординга ЗД - вход по логину/паролю + кнопка «назад».
   СМЕНИ ЛОГИН/ПАРОЛЬ В СЛЕДУЮЩЕЙ СТРОКЕ ↓ (это единственное место). */
(function () {
  var USER = "zd", PASS = "Nastroyka-2026";   // <- логин и пароль сюда
  var OK = "apx_zdnastr_gate_ok";
  var authed = false;
  ...
  ready(function () {
    ...
    // Кнопка «← К домашке» на всех страницах, кроме главной домашки
    if (!isMain) {
      var b = document.createElement("a");
      b.href = "index.html";
      b.textContent = "← К домашке";
      b.setAttribute("style", "position:fixed;top:12px;left:12px;z-index:9998;background:#12372A;color:#fff;border-radius:8px;padding:8px 13px;font:600 13px -apple-system,Segoe UI,Roboto,sans-serif;text-decoration:none;box-shadow:0 4px 12px rgba(0,0,0,.2)");
    ...
    d.innerHTML =
      ...
      '<div style="font-weight:800;color:#12372A;font-size:19px">A-PLAYERS · Онбординг менеджеров</div>' +
      '<div style="color:#6B756F;font-size:13.5px;margin:4px 0 18px">Инструкция по управлению платформой. Вход по логину и паролю.</div>' +
