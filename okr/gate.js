/* A-Players · OGSM и OKR — вход по логину/паролю.
   СМЕНИ ЛОГИН/ПАРОЛЬ В СЛЕДУЮЩЕЙ СТРОКЕ ↓ (это единственное место). */
(function () {
  var USER = "okr", PASS = "OKR-2026";   // ← логин и пароль сюда
  var OK = "apx_okr_gate_ok";
  var authed = false;
  ...
  ready(function () {
    ...
    d.innerHTML =
      ...
      '<div style="font-weight:800;color:#143A2D;font-size:19px">A-PLAYERS · OGSM и OKR</div>' +
