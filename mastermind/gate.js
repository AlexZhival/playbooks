...
(function () {
  var USER = "mastermind", PASS = "Mastermind-2026";   // ← логин и пароль сюда
  var OK = "apx_gate_ok";
  var authed = false;
  try { authed = sessionStorage.getItem(OK) === "1"; } catch (e) {}
  var page = location.pathname.split("/").pop();
  var isMain = (page === "" || page === "index.html" || page === "dz-obyortka.html");
  ...
  ready(function () {
    ...
    d.innerHTML =
      ...
      '<div style="font-weight:800;color:#12372A;font-size:19px">A-PLAYERS · Pro Vibe Coding</div>' +
      '<div style="color:#6B756F;font-size:13.5px;margin:4px 0 18px">Материалы мастермайнда. Вход по логину и паролю.</div>' +
