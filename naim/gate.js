...
(function () {
  var USER = "naim", PASS = "NAIM-2026";   // ← логин и пароль сюда
  var OK = "apx_naim_gate_ok";
  var authed = false;
  ...
  ready(function () {
    ...
    d.innerHTML =
      ...
      '<div style="font-weight:800;color:#143A2D;font-size:19px">A-PLAYERS · Воронка найма</div>' +
