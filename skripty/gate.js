/* A-Players · Драйверы роста — вход по логину/паролю + кнопка «назад».
   СМЕНИ ЛОГИН/ПАРОЛЬ В СЛЕДУЮЩЕЙ СТРОКЕ ↓ (это единственное место). */
(function () {
  var USER = "skripty", PASS = "Skripty-2026";   // ← логин и пароль сюда
  var OK = "apx_skripty_gate_ok";
  var authed = false;
  ...
  ready(function () {
    ...
    // Кнопка «← К домашке» на всех страницах, кроме главной
    if (!isMain) {
    ...
    d.innerHTML =
      ...
      '<div style="font-weight:800;color:#143A2D;font-size:19px">A-PLAYERS · Высококонверсионные скрипты</div>' +
