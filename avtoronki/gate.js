...
(function () {
  ...
  ready(function () {
    ...
    d.innerHTML =
      '<div style="background:#FBF8F1;border-radius:16px;padding:30px 28px;width:340px;max-width:90vw;box-shadow:0 20px 60px rgba(0,0,0,.4);text-align:center">' +
      '<div style="font-weight:800;color:#143A2D;font-size:19px">A-PLAYERS · Автоворонки и парники</div>' +
