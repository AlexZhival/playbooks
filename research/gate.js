/* A-Players · Pro-Research — вход по логину/паролю + кнопка «назад».
   СМЕНИ ЛОГИН/ПАРОЛЬ В СЛЕДУЮЩЕЙ СТРОКЕ ↓ (это единственное место). */
(function () {
  var USER = "research", PASS = "Research-2026";   // ← логин и пароль сюда
  var OK = "apx_research_gate_ok";
  var authed = false;
  ...
  ready(function () {
    ...
    d.innerHTML =
      ...
      '<div style="font-weight:800;color:#143A2D;font-size:19px">A-PLAYERS · Pro-Research</div>' +
