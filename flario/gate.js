...
(function () {
  var USER = "flario", PASS = "Flario-2026";   // ← логин и пароль сюда
  var OK = "apx_gate_ok";
  var authed = false;
  ...
  ready(function () {
    ...
    d.innerHTML =
      ...
      '<div style="color:#6B756F;font-size:13.5px;margin:4px 0 18px">Материалы практикума. Вход по логину и паролю.</div>' +
