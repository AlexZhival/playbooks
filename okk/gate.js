...
(function () {
  var USER = "okk", PASS = "OKK-2026";   // ← логин и пароль сюда
  var OK = "apx_okk_gate_ok";
  var authed = false;
  ...
  ready(function () {
    ...
    d.innerHTML =
      ...
      '<div style="font-weight:800;color:#143A2D;font-size:19px">A-PLAYERS · Отдел контроля качества</div>' +
