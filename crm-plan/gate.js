...
(function () {
  var USER = "crm", PASS = "CRM-2026";   // ← логин и пароль сюда
  var OK = "apx_crm_gate_ok";
  var authed = false;
  ...
  ready(function () {
    ...
    d.innerHTML =
      ...
      '<div style="font-weight:800;color:#143A2D;font-size:19px">A-PLAYERS · CRM + план продаж</div>' +
