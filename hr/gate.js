...
(function () {
  var USER = "hr", PASS = "HR-2026";   // ← логин и пароль сюда
  var OK = "apx_hr_gate_ok";
  var authed = false;
  ...
  ready(function () {
    ...
    d.innerHTML =
      ...
      '<div style="font-weight:800;color:#143A2D;font-size:19px">A-PLAYERS · HR-функция</div>' +
